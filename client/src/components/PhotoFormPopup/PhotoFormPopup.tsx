...
export const PhotoFormPopup = () => {
	const { isOpen } = useAppSelector(store => store.ui)
	...
	return (
		<form
			className={`fixed flex flex-col px-8 py-6 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-10/12 max-w-[38.75rem] bg-white rounded-xl shadow-button ${
				isOpen
